...
//need to change the getStockList(), showGraph(), updateMoneyEarned() and updateTime() to work with actual stocks
...
public class Screen extends JFrame implements ActionListener
{
    ...
    private static String stock1, stock2, stock3, stock4, stock5;
